...
**2** Ped file
* Ped file is used to describe the sample relationship, details in [Ped](https://gatk.broadinstitute.org/hc/en-us/articles/360035531972-PED-Pedigree-format).  Notice: sample ID in Ped file should be consistent with VCF name
